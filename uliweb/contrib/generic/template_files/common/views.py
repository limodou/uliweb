...
#            rows_per_page=rows, #get rows info from request
    ...
    def add(self):
        ...
        template_data = {'layout':'{{=appname}}_layout.html'}
...
#        response.template = 'GenericView/add.html'
        return view.run(json_result={{=addview_ajax}})
...
#        response.template = 'GenericView/edit.html'
        return view.run(json_result={{=editview_ajax}})
    ...
    def delete(self, id):
        ...
        return view.run(json_result={{=deleteview_ajax}})
